...
from ..env import tf
from ..tf_layers import Module, Conv2d, UpSampling2d, UpSampleBilinear2d
...
class TransformerSR_g(Module):
    """Transformer generator (2× SR), compatible with the repo's NCHW training pipeline."""
